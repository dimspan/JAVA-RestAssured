...
public class APItestXML_XSD_URL {
    ...
    private static final String XML_URL = "xxxxxxxx/xxxxxxxxx/xxxxxxx"; // Update with actual API URL
    private static final String XSD_URL = "xxxxxxxxxxxxxxxxxxxx"; // Update with actual XSD URL
