...
public class N17B2 {
    ...
    public void setUp() throws Exception {
        String xmlUrl = "http://icodev.ldev.enetpulse.com:8003/n_files/discipline/8/types/194/n_files/604/xmlPreviewTab";
...
//        htmlFormatValidator.fetchXmlFile();
    ...
    public void checkAllElementsAttributes() throws Exception {
        hardcodedValues.checkOdfBodyAttributes(xmlContent,"OWG2026","SMT701N17B2","DT_BCK_IMP","ENG","T","HR");
        ...
        hardcodedValues.checkDocumentAttributes(xmlContent,"0","PRE","Past Results","701N17B2","SMT0117B2","H");
    }
