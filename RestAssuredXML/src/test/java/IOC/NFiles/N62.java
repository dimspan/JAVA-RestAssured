...
public class N62 {
    ...
    public void setUp() throws Exception {
        String xmlUrl = "http://icodev.ldev.enetpulse.com:8003/n_files/discipline/2/types/109/n_files/731/xmlPreviewTab?participant_id=295";
...
//        htmlFormatValidator.fetchXmlFile();
    ...
    public void checkAllElementsAttributes() throws Exception {
        hardcodedValues.checkOdfBodyAttributes(xmlContent,"OWG2026","IHO1010N62","DT_BCK_IMP","ENG","T","HR");
        hardcodedValues.checkCompetitionAttributes(xmlContent,"OWG-2026-GEN-4.4");
        hardcodedValues.checkCategoryAttributes(xmlContent,"IHO","Ice Hockey","Y");
        hardcodedValues.checkDocumentAttributes(xmlContent,"0","PRE","Past Results","1010N62","IHO1062","H");
    }
