...
public class N17D {
    ...
    public void setUp() throws Exception {
        String xmlUrl = "http://icodev.ldev.enetpulse.com:8003/n_files/discipline/5/types/122/n_files/122/xmlPreviewTab";
...
//        htmlFormatValidator.fetchXmlFile();
    ...
    public void checkAllElementsAttributes() throws Exception {
        hardcodedValues.checkOdfBodyAttributes(xmlContent,"OWG2026","BOB702N17D","DT_BCK_IMP","ENG","T","HR");
        ...
        hardcodedValues.checkDocumentAttributes(xmlContent,"0","PRE","Past Results","702N17D","BOB0217D","H");
    }
