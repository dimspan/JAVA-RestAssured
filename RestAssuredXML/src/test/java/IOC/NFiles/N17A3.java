...
public class N17A3 {
    ...
    public void setUp() throws Exception {
        String xmlUrl = "http://icodev.ldev.enetpulse.com:8003/n_files/discipline/73/types/106/n_files/513/xmlPreviewTab";
...
//        htmlFormatValidator.fetchXmlFile();
    ...
    public void checkAllElementsAttributes() throws Exception {
        hardcodedValues.checkOdfBodyAttributes(xmlContent,"OWG2026","SJP806N17A3","DT_BCK_IMP","ENG","T","HR");
        hardcodedValues.checkCompetitionAttributes(xmlContent,"OWG-2026-GEN-4.4");
        hardcodedValues.checkCategoryAttributes(xmlContent,"SJP","Ski Jumping","Y");
        hardcodedValues.checkDocumentAttributes(xmlContent,"0","PRE","Past Results","806N17A3","SJP0617A3","H");
    }
