...
public class N22Pair {
    ...
    public void checkAllElementsAttributes() throws Exception {
        ...
        hardcodedValues.checkTeamBiographyAttributes(xmlContent,"X","USA","CHOCK Madison / BATES Evan","Y", "T000000889885");
        hardcodedValues.checkTeamBiographyLanguageAttributes(xmlContent,"ENG");
        hardcodedValues.checkDisciplineAttributes(xmlContent,"FSK-------------------------------");
        hardcodedValues.checkRegisteredEventAttributes(xmlContent,"FSKXICEDANCE----------------------");
    }
