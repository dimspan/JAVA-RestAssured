...
public class N17C {
    ...
    public void setUp() throws Exception {
        String xmlUrl = "http://icodev.ldev.enetpulse.com:8003/n_files/discipline/5/types/121/n_files/121/xmlPreviewTab";
...
//        htmlFormatValidator.fetchXmlFile();
    ...
    public void checkAllElementsAttributes() throws Exception {
        hardcodedValues.checkOdfBodyAttributes(xmlContent,"OWG2026","BOB604N17C","DT_BCK_IMP","ENG","T","HR");
        hardcodedValues.checkCompetitionAttributes(xmlContent,"OWG-2026-GEN-4.4");
        hardcodedValues.checkCategoryAttributes(xmlContent,"BOB","Bobsleigh","Y");
        hardcodedValues.checkDocumentAttributes(xmlContent,"0","PRE","Past Results","604N17C","BOB0417C","H");
    }
