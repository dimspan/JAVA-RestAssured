...
public class N17B1 {
    ...
    public void setUp() throws Exception {
        String xmlUrl = "http://icodev.ldev.enetpulse.com:8003/n_files/discipline/8/types/193/n_files/602/xmlPreviewTab";
...
//        htmlFormatValidator.fetchXmlFile();
    ...
    public void checkAllElementsAttributes() throws Exception {
        hardcodedValues.checkOdfBodyAttributes(xmlContent,"OWG2026","SMT601N17B1","DT_BCK_IMP","ENG","T","HR");
        hardcodedValues.checkCompetitionAttributes(xmlContent,"OWG-2026-GEN-4.4");
        hardcodedValues.checkCategoryAttributes(xmlContent,"SMT","Ski Mountaineering","Y");
        hardcodedValues.checkDocumentAttributes(xmlContent,"0","PRE","Past Results","601N17B1","SMT0117B1","H");
    }
