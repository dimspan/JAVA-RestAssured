...
public class participants {
    ...
    public void setUp() throws Exception {
        String xmlUrl = "https://iocweb.enetpulse.com/competitions/5027/generate_export_2_0/participants";
    ...
    public void hardcodedValues() throws JAXBException {
        ...
        hardcodedValues.checkIndividualProfileParticipantAttributes("SDIS$BOB","Bobsleigh");
        hardcodedValues.checkIndividualProfileAthleteAttributes("885758","1987-01-06","Justin Kripps","PGEN$M","Kripps",
                "Justin","183","100","CNTR$CAN");
