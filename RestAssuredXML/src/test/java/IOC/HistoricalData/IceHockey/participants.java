...
public class participants {
    ...
    public void setUp() throws Exception {
        String xmlUrl = "https://iocweb.enetpulse.com/competitions/5047/generate_export_2_0/participants";
    ...
    public void hardcodedValues() throws JAXBException {
        ...
        hardcodedValues.checkIndividualProfileParticipantAttributes("SDIS$IHO","Ice Hockey");
        hardcodedValues.checkIndividualProfileAthleteAttributes("1194","1988-09-09","Morten Poulsen","PGEN$M","Poulsen",
                "Morten","186","96","CNTR$DEN");
