...
public class participants {
    ...
    public void setUp() throws Exception {
        String xmlUrl = "https://iocweb.enetpulse.com/competitions/5032/generate_export_2_0/participants";
    ...
    public void hardcodedValues() throws JAXBException {
        ...
        hardcodedValues.checkIndividualProfileParticipantAttributes("SDIS$SMT","Ski Mountaineering");
        hardcodedValues.checkIndividualProfileAthleteAttributes("303321","1991-02-24","Phillip Bellingham","PGEN$M","Bellingham",
                "Phillip","185","84","CNTR$AUS");
        hardcodedValues.checkIndividualProfileTeamAttributes(0,"1709203_1709594-20079","EVNT$SMTTeam","William Bon Mardion / Xavier Gachet",
                "PGEN$M","TTYP$CPLP");
    }
