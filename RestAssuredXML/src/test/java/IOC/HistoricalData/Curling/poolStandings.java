...
public class poolStandings {
    ...
    public void setUp() throws Exception {
        String xmlUrl = "https://iocweb.enetpulse.com/competitions/5053/generate_export_2_0/pool_standings";
    ...
    public void hardcodedValues() throws JAXBException {
        ...
        hardcodedValues.checkPoolStandingsAttributes(0,"20270_pr","Pool","RCST$OFFICIAL");
        hardcodedValues.checkPoolStandingsEventAttributes(0,"20270","TEAM","World Men's Curling Championship",
                "1","EVNT$CURTeam","SGEN$M");
        hardcodedValues.checkPoolStandingsEventDisciplineAttributes(0,"SDIS$CUR","Curling");
        hardcodedValues.checkPoolStandingsEventDisciplineCompetitionAttributes(0,"5053","2025 World Championships",
                "CNTR$CAN","Moose Jaw");
    }
