...
public class XMLvalidator {
    ...
    private static final String XML_FILE_PATH = "/xxxxxxx/xxxxxxxx/xxxxx"; // Local XML file
    private static final String XSD_SCHEMA_PATH = "xxxxxxxxxxxxxx/xxxxxxx/xxxxxxxxxx"; // Local XSD file
